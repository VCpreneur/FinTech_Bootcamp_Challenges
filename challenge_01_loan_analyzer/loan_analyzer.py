...
print(f"The total sum of all loans is: {total_of_all_loans}")
...
print(f"The present (fair) value of the loan is: {present_value}")
...
# YOUR CODE HERE!
inexpensive_loans_threshold = 500
for loan in loans:
    loan_price = loan.get("loan_price")
    if loan_price <= inexpensive_loans_threshold:
...
# It is expected to find a csv file in the same folder of this python file
# The output file should have the name "inexpensive_loans.csv"
# To double check the results, "inexpensive_loans.csv" should only include loans that are priced <= $500
